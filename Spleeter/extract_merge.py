...
if __name__ == "__main__":
    dir_path = "/Volumes/LenovoDisk/genres分离后/rock_se"     # 待提取合并的文件夹的路径
    accompany_dir = "/Volumes/LenovoDisk/GTZAN伴奏"     # 存放所有伴奏的文件夹
    vocals_dir = "/Volumes/LenovoDisk/GTZAN人声"   # 存放所有人声的文件夹
